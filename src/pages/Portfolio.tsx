...
const portfolioCompanies = [
  { id: 1, name: "Stealth", sector: "Enterprise" },
  { id: 2, name: "Stealth", sector: "Consumer" },
  { id: 3, name: "Stealth", sector: "Fintech" },
  { id: 4, name: "Stealth", sector: "Health" },
  { id: 5, name: "Stealth", sector: "Climate" },
  { id: 6, name: "Stealth", sector: "AI/ML" },
];
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto text-center mb-24 animate-fade-in">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              We maintain discretion regarding our investments. 
              Portfolio companies are disclosed at their discretion.
            </p>
          </div>
